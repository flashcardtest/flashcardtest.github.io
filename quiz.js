...
const topics = {
   ...
   const topics = {
       chemistry: [{
           ...
           {
               question: "Quel type de liaison existe entre deux atomes de fluor dans F2 ?",
               answers: ["Liaison ionique", "Liaison covalente polaire", "Liaison covalente non polaire", "Liaison métallique"],
               correct: 2
           },
           {
               question: "Quelle grandeur représente 'n' dans l'équation des gaz parfaits PV = nRT ?",
               answers: ["La masse", "Le volume", "Le nombre de moles", "La densité"],
               correct: 2
           },
           {
               question: "Quelle est la forme géométrique d'une molécule de méthane (CH4) ?",
               answers: ["Linéaire", "Angulaire", "Pyramide trigonale", "Tétraédrique"],
               correct: 3
           },
           {
               question: "Quel est le rôle d’un tampon (ou solution tampon) ?",
               answers: ["Changer le pH rapidement", "Rendre une solution basique", "Stabiliser le pH", "Rendre une solution conductrice"],
               correct: 2
           },
           {
               question: "Quelle est l’unité de l’enthalpie standard ΔH ?",
               answers: ["mol/L", "g/mol", "Joule", "kJ/mol"],
               correct: 3
           },
           {
               question: "Dans une réaction redox, que subit l’élément oxydé ?",
               answers: ["Il perd des électrons", "Il gagne des électrons", "Il ne change pas", "Il libère des neutrons"],
               correct: 0
           },
           {
               question: "Quel est le nom de CH3COOH ?",
               answers: ["Acide chlorhydrique", "Acide formique", "Acide nitrique", "Acide acétique"],
               correct: 3
           },
           {
               question: "Quelle est la relation entre la température et la vitesse d’une réaction chimique ?",
               answers: ["La température n’a aucun effet", "Plus la température est basse, plus la réaction est rapide", "Plus la température est élevée, plus la réaction est rapide", "La température transforme l’équilibre chimique"],
               correct: 2
           },
           {
               question: "Quelle est la base conjuguée de l’acide H2O ?",
               answers: ["OH⁻", "H₃O⁺", "H⁺", "O²⁻"],
               correct: 0
           },
           {
               question: "Lors d’une titration, que représente le point d’équivalence ?",
               answers: ["Le moment où la base est en excès", "Le moment où l’acide est complètement neutralisé", "La fin de la réaction", "Le début de la réaction"],
               correct: 1
           },
           {
               question: "Quel est le composé formé lorsque l'éthanol réagit avec l'acide éthanoïque ?",
               answers: ["Éther", "Cétone", "Ester", "Aldéhyde"],
               correct: 2
           },
           {
               question: "Quel est le nom de la molécule C6H6 ?",
               answers: ["Méthane", "Hexane", "Benzène", "Éthanol"],
               correct: 2
           },
           {
               question: "Quel est le rôle d’un catalyseur dans une réaction chimique ?",
               answers: ["Augmenter la masse molaire", "Modifier l’état des produits", "Abaisser l’énergie d’activation", "Ralentir la réaction"],
               correct: 2
           },
           {
               question: "Quel est le nom de la réaction entre un acide carboxylique et un alcool ?",
               answers: ["Saponification", "Estérification", "Hydrolyse", "Addition"],
               correct: 1
           },
           {
               question: "Quelle est la configuration électronique du sodium (Z = 11) ?",
               answers: ["1s² 2s² 2p⁶ 3s¹", "1s² 2s² 2p⁵ 3s²", "1s² 2s² 2p⁶ 3s²", "1s² 2s² 2p⁶"],
               correct: 0
           },
       ],
       biology: [{
